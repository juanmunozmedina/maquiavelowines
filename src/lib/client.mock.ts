...
const products: Record<string, Product> = {
	...
	'ancestral-monastrell-pie-franco': {
		...
		description: '',
		price: 3400,
		imageUrl: '/assets/ancestral.webp',
	...
	'ancestral-monastrell-crianza': {
		...
		description: '',
		price: 1580,
		imageUrl: '/assets/ancestral_crianza.webp',
		collectionIds: ['ancestral'],
		variants: apparelVariants,
	},
	'ancestral-alicante-bouschet': {
		...
		description: '',
		price: 1580,
		imageUrl: '/assets/ancestral_bouschet.webp',
		collectionIds: ['ancestral'],
		variants: apparelVariants,
	},
	'espumoso-brut': {
	...
	'espumoso-dulce-blanco': {
		...
		description: '',
		price: 1190,
		imageUrl: '/assets/sweetgreen.webp',
		collectionIds: ['centhaurus'],
		variants: apparelVariants,
	},
