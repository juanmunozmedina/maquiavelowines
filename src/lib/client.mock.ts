...
const products: Record<string, Product> = {
	...
	'brut-rose-excelence-espumoso': {
		...productDefaults,
		id: 'brut-rose-excelence-espumoso',
		name: 'Brut Rosé Excelence Espumoso',
		slug: 'brut-rose-excelence-espumoso',
		tagline: 'Maquiavelo edición especial de vino espumoso brut rosé excelence.',
		description:
		...
		price: 1590,
		imageUrl: '/assets/brut_rose_excelence.png',
		collectionIds: ['maquiavelo'],
		variants: [
			{
				id: 'brut-rose-excelence-espumoso-3',
				name: 'Brut Rosé Excelence Espumoso Pack 3 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 3 botellas' },
				priceVariant: 3180,
			},
			{
				id: 'brut-rose-excelence-espumoso-6',
				name: 'Brut Rosé Excelence Espumoso Pack 6 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 6 botellas' },
				priceVariant: 7950,
			},
			{
				id: 'brut-rose-excelence-espumoso-12',
				name: 'Brut Rosé Excelence Espumoso Pack 12 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 12 botellas' },
				priceVariant: 17490,
			},
	...
	'brut-excelence-espumoso': {
		...productDefaults,
		id: 'brut-excelence-espumoso',
		name: 'Brut Excelence Espumoso',
		slug: 'brut-excelence-espumoso',
		tagline: 'Maquiavelo edición especial de vino espumoso brut excelence.',
		description:
		...
		price: 1590,
		imageUrl: '/assets/brut_excelence.png',
		collectionIds: ['maquiavelo'],
		variants: [
			{
				id: 'brut-excelence-espumoso-3',
				name: 'Brut Excelence Espumoso Pack 3 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 3 botellas' },
				priceVariant: 3180,
			},
			{
				id: 'brut-excelence-espumoso-6',
				name: 'Brut Excelence Espumoso Pack 6 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 6 botellas' },
				priceVariant: 7950,
			},
			{
				id: 'brut-excelence-espumoso-12',
				name: 'Brut Excelence Espumoso Pack 12 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 12 botellas' },
				priceVariant: 17490,
			},
