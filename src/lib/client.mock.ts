...
/*const apparelVariants = ['Pack 3 botellas', 'Pack 6 botellas', 'Pack 12 botellas', 'Pack 24 botellas'].map(
	(size, index) => ({
		id: size,
		name: size,
		stock: index * 10,
...
const products: Record<string, Product> = {
	...
	vermut: {
		...
		technical: 'https://s.imero.io/p/6797941608e6ce2bb61413fc/e-label/6797941508e6ce2bb61413f2',
		price: 1190,
	...
	'ancestral-monastrell-pie-franco': {
		...
		medal: ['/assets/oro-2023.webp', '/assets/plata-2024.webp'],
		...
		variants: [
			...
			{
				id: 'ancestral-monastrell-pie-franco-24',
				name: 'Ancestral Monastrell Pie Franco Pack 24 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 24' },
				priceVariant: 78200,
			},
	...
	'ribera-del-duero-tempranillo-10-meses': {
		...productDefaults,
		id: 'ribera-del-duero-tempranillo-10-meses',
		name: 'Ribera del Duero Tempranillo 10 meses',
		slug: 'ribera-del-duero-tempranillo-10-meses',
		tagline: 'Maquiavelo Ribera del Duero Tempranillo de 10 meses, vino de autor.',
		medal: ['/assets/gran-oro-2025.webp'],
		price: 1890,
		imageUrl: '/assets/ribera_tempranillo.png',
		collectionIds: ['maquiavelo'],
		variants: [
			{
				id: 'ribera-del-duero-tempranillo-10-meses-3',
				name: 'Ribera del Duero Tempranillo 10 meses Pack 3 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 3' },
				priceVariant: 3780,
			},
			{
				id: 'ribera-del-duero-tempranillo-10-meses-6',
				name: 'Ribera del Duero Tempranillo 10 meses Pack 6 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 6' },
				priceVariant: 9450,
			},
			{
				id: 'ribera-del-duero-tempranillo-10-meses-12',
				name: 'Ribera del Duero Tempranillo 10 meses Pack 12 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 12' },
				priceVariant: 20790,
			},
			{
				id: 'ribera-del-duero-tempranillo-10-meses-24',
				name: 'Ribera del Duero Tempranillo 10 meses Pack 24 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 24' },
				priceVariant: 43470,
			},
	...
	'adn-verdejo': {
		...
		variants: [
			...
			{
				id: 'adn-verdejo-24',
				name: 'ADN Verdejo Pack 24 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 24' },
				priceVariant: 24610,
			},
	...
	'ancestral-petit-verdot': {
		...
		variants: [
			...
			{
				id: 'ancestral-petit-verdot-24',
				name: 'Ancestral Petit Verdot Pack 24 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 24' },
				priceVariant: 55200,
			},
	...
	'ancestral-cabernet': {
		...
		variants: [
			...
			{
				id: 'ancestral-cabernet-24',
				name: 'Ancestral Cabernet Pack 24 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 24' },
				priceVariant: 43700,
			},
	...
	'vermut-citrus': {
		...
		price: 1190,
		imageUrl: '/assets/vermut_citrus.png',
		collectionIds: ['maquiavelo'],
		variants: [
			{
				id: 'vermut-citrus-3',
			...
			{
				id: 'vermut-citrus-24',
				name: 'Vermut Citrus Pack 24 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 24' },
				priceVariant: 27370,
			},
	...
	'vinas-selectas': {
		...
		variants: [
			...
			{
				id: 'vinas-selectas-24',
				name: 'Viñas Selectas Pack 24 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 24' },
				priceVariant: 17825,
			},
	...
	'adn-sauvignon-blanc': {
		...
		description:
			'<div><p><b>Botella</b>: 75 cl.</p><p><b>Tipo de uva</b>: Sauvignon Blanc</p><p><b>Graduación</b>: 12% Alc. Vol.</p><p><b>Año</b>: Añada más reciente.</p><p><b>Denominación de origen</b>: Jumilla (Protegida)</p></div><div><p><b>Descripción</b></p><p>Maquiavelo ADN Sauvignon Blanc es un vino blanco joven de la cosecha más reciente elaborado en su totalidad con selecta uva sauvignon blanc. Su sabor destaca por ser suave en paladar y con un toque semi seco en boca. Ideal para acompañar con cualquier tipo de pescados, mariscos, verduras, pastas con salsas suaves o incluso para degustar solo plácidamente. Un vino joven para los paladares que no te dejará indiferente.</p><p><b>Recomendaciones</b></p><p>Servir entre 7 y 10°C. Conservar en posición horizontal. Una vez abierto, consumir preferentemente en un máximo de 2/3 días y tapar con el propio corcho.</p></div>',
		price: 1070,
		...
		variants: [
			...
			{
				id: 'adn-sauvignon-blanc-24',
				name: 'ADN Sauvignon Blanc Pack 24 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 24' },
				priceVariant: 24610,
			},
	...
	'brut-rose-excellence-espumoso': {
		...
		variants: [
			...
			{
				id: 'brut-rose-excellence-espumoso-24',
				name: 'Brut Rosé Excellence Espumoso Pack 24 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 24' },
				priceVariant: 38160,
			},
	...
	'brut-excellence-espumoso': {
		...
		variants: [
			...
			{
				id: 'brut-excellence-espumoso-24',
				name: 'Brut Excellence Espumoso Pack 24 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 24' },
				priceVariant: 38160,
			},
	...
	'ribera-del-duero-tempranillo-barrica': {
		...productDefaults,
		id: 'ribera-del-duero-tempranillo-barrica',
		name: 'Ribera del Duero Tempranillo Barrica',
		slug: 'ribera-del-duero-tempranillo-barrica',
		tagline: 'Maquiavelo Ribera del Duero Tempranillo Barrica, vino de autor.',
		medal: ['/assets/plata-2025.webp'],
		price: 1490,
		imageUrl: '/assets/ribera_tempranillo_barrica.png',
		collectionIds: ['maquiavelo'],
		variants: [
			{
				id: 'ribera-del-duero-tempranillo-barrica-3',
				name: 'Ribera del Duero Tempranillo Barrica Pack 3 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 3' },
				priceVariant: 2980,
			},
			{
				id: 'ribera-del-duero-tempranillo-barrica-6',
				name: 'Ribera del Duero Tempranillo Barrica Pack 6 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 6' },
				priceVariant: 7450,
			},
			{
				id: 'ribera-del-duero-tempranillo-barrica-12',
				name: 'Ribera del Duero Tempranillo Barrica Pack 12 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 12' },
				priceVariant: 16390,
			},
			{
				id: 'ribera-del-duero-tempranillo-barrica-24',
				name: 'Ribera del Duero Tempranillo Barrica Pack 24 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 24' },
				priceVariant: 34270,
			},
	...
	'ancestral-monastrell-crianza': {
		...
		variants: [
			...
			{
				id: 'ancestral-monastrell-crianza-24',
				name: 'Ancestral Monastrell Crianza Pack 24 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 24' },
				priceVariant: 29670,
			},
	...
	'espumoso-brut': {
		...
		description:
			'<div> <p><b>Botella</b>: 75 cl.</p> <p><b>Tipo de uva</b>: Macabeo</p> <p><b>Graduación</b>: 11% Alc. Vol.</p> <p><b>Año</b>: Añada más reciente.</p> </div> <div> <p><b>Nota de cata</b></p> <p>Vino intenso donde predominan los aromas varietales con un fondo de cítricos y frutas tropicales.</p> <p>Un vino de gran frescura que se muestra agradable y expresivo en boca.</p> <p><b>Recomendaciones</b></p> <p>Degustar entre 8 y 10°C. Conservar en posición horizontal. Una vez abierto, consumir preferentemente en un máximo de 2/3 días y tapar con el propio corcho.</p></div>',
		price: 1570,
		...
		variants: [
			...
			{
				id: 'espumoso-brut-24',
				name: 'Espumoso Brut Pack 24 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 24' },
				priceVariant: 36110,
			},
	...
	'espumoso-dulce-blanco': {
		...
		description:
			'<div> <p><b>Botella</b>: 75 cl.</p> <p><b>Tipo de uva</b>: Macabeo</p> <p><b>Graduación</b>: 8% Alc. Vol.</p> <p><b>Año</b>: Añada más reciente.</p> </div> <div> <p><b>Nota de cata</b></p> <p>Bebida aromatizada a base de vino.</p> <p>Fresco, afrutado con un bajo contenido en alcohol, ideal para todo tipo de comidas y eventos.</p> <p><b>Recomendaciones</b></p> <p>Degustar entre 8 y 10°C. Conservar en posición horizontal. Una vez abierto, consumir preferentemente en un máximo de 2/3 días y tapar con el propio corcho.</p></div>',
		price: 1190,
		...
		variants: [
			...
			{
				id: 'espumoso-dulce-blanco-24',
				name: 'Espumoso Dulce Blanco Pack 24 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 24' },
				priceVariant: 27370,
			},
	...
	'espumoso-dulce-rosado': {
		...
		description:
			'<div> <p><b>Botella</b>: 75 cl.</p> <p><b>Tipo de uva</b>: Bobal</p> <p><b>Graduación</b>: 8% Alc. Vol.</p> <p><b>Año</b>: Añada más reciente.</p> </div> <div> <p><b>Nota de cata</b></p> <p>Bebida aromatizada a base de vino.</p> <p>Fresco, afrutado con un bajo contenido en alcohol, ideal para todo tipo de comidas y eventos.</p> <p><b>Recomendaciones</b></p> <p>Degustar entre 8 y 10°C. Conservar en posición horizontal. Una vez abierto, consumir preferentemente en un máximo de 2/3 días y tapar con el propio corcho.</p></div>',
		price: 1190,
		...
		variants: [
			...
			{
				id: 'espumoso-dulce-rosado-24',
				name: 'Espumoso Dulce Rosado Pack 24 botellas',
				stock: 0,
				options: { Tamaño: 'Pack 24' },
				priceVariant: 27370,
			},
	...
	'espumoso-semiseco': {
		...
		variants: [
			...
			{
				id: 'espumoso-semiseco-24',
				name: 'Espumoso Semiseco Pack 24 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 24' },
				priceVariant: 37680,
			},
	...
	'coraline-syrah-rose-premium': {
		...productDefaults,
		id: 'coraline-syrah-rose-premium',
		name: 'Coraline Syrah Rosé Premium',
		slug: 'coraline-syrah-rose-premium',
		tagline: 'Maquiavelo y syrah rosé premium.',
		description:
			'<div> <p><b>Botella</b>: 75 cl.</p> <p><b>Tipo de uva</b>: Syrah</p> <p><b>Graduación</b>: 12% Alc. Vol.</p> <p><b>Sub-zona</b>: Paraje de la Fuente la Negra</p> <p><b>Denominación de origen</b>: Varietal CLM Yecla & Fuente Álamo</p> </div> <div> <p><b>Tapón</b>: Corcho natural.</p> <p><b>Color</b>: Color piel de cebolla intenso con reflejos azules, brillante y cristalino. Potente y expresiva nariz, muy aromática fruta roja (fresa, frambuesa y grosella). En boca se muestra goloso, amplio, muy fresco y con un post-gusto largo y agradable, donde vuelven a parecer esos aromas con recuerdos frutales.</p> <p><b>Descripción</b></p> <p><b>Elaboración</b>: Despalillado suave. Maceración durante un breve periodo de tiempo y sangrado de mosto en flor, fermentado a una temperatura no superior a 17° C.<br> <b>Maridaje:</b> Aconsejable para acompañar platos de pasta, ensaladas, pescados blancos, mariscos y arroces.<br> <b>Servicio:</b> Entre 8-10° C.<br> <b>Notas de cata:</b> Vino rosado de la variedad Syrah. Aromas varietales elegantes a flores y frutas rojas. Paso en boca ligeramente acido, transmite sensaciones de frescura con agradable sensación final. Aspecto brillante y limpio con tonalidades frambuesa.</p> <p><b>Enólogo</b></p> <p>Seleccionado por Fernando Galvañ, winemaker.</p> </div>',
		price: 1190,
		imageUrl: '/assets/coraline_syrah.png',
		collectionIds: ['maquiavelo'],
		variants: [
			{
				id: 'coraline-syrah-rose-premium-3',
				name: 'Coraline Syrah Rosé Premium Pack 3 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 3' },
				priceVariant: 2380,
			},
			{
				id: 'coraline-syrah-rose-premium-6',
				name: 'Coraline Syrah Rosé Premium Pack 6 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 6' },
				priceVariant: 5950,
			},
			{
				id: 'coraline-syrah-rose-premium-12',
				name: 'Coraline Syrah Rosé Premium Pack 12 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 12' },
				priceVariant: 13090,
			},
			{
				id: 'coraline-syrah-rose-premium-24',
				name: 'Coraline Syrah Rosé Premium Pack 24 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 24' },
				priceVariant: 27370,
			},
	...
	'vermut-naranja': {
		...
		variants: [
			{
				id: 'vermut-naranja-3',
				name: 'Vermut Naranja Pack 3 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 3' },
				priceVariant: 2380,
			},
			{
				id: 'vermut-naranja-6',
				name: 'Vermut Naranja Pack 6 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 6' },
				priceVariant: 5950,
			},
			{
				id: 'vermut-naranja-12',
				name: 'Vermut Naranja Pack 12 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 12' },
				priceVariant: 13090,
			},
			{
				id: 'vermut-naranja-24',
				name: 'Vermut Naranja Pack 24 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 24' },
				priceVariant: 27370,
			},
	...
	'vermut-blanco': {
		...
		variants: [
			{
				id: 'vermut-blanco-3',
				name: 'Vermut Blanco Pack 3 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 3' },
				priceVariant: 2380,
			},
			{
				id: 'vermut-blanco-6',
				name: 'Vermut Blanco Pack 6 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 6' },
				priceVariant: 5950,
			},
			{
				id: 'vermut-blanco-12',
				name: 'Vermut Blanco Pack 12 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 12' },
				priceVariant: 13090,
			},
			{
				id: 'vermut-blanco-24',
				name: 'Vermut Blanco Pack 24 botellas',
				stock: 1000,
				options: { Tamaño: 'Pack 24' },
				priceVariant: 27370,
			},
